...
CREATE SEQUENCE public."id-veiculo"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 1000000
...
ALTER TABLE public."id-veiculo" OWNER TO ti2cc;
...
CREATE TABLE public.veiculo (
    id integer DEFAULT nextval('public."id-veiculo"'::regclass) NOT NULL,
    marca text,
    modelo text,
    ano integer,
...
ALTER TABLE public.veiculo OWNER TO ti2cc;
